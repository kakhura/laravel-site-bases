                                            ...
                                            <div class="panel-body">
                                                <div class="row">
                                                    @foreach ($project->images as $key => $value)
                                                        <div class="col-md-4">
                                                            <div class="thumbnail">
                                                                <div class="image view view-first" data-id="{{$value->id}}" data-main="{{$project->id}}">
                                                                    <img src="{{asset($value->image)}}">
                                                                </div>
                                                                <div class="caption">
                                                                    <div class="btn btn-danger delImg" data-img="{{ asset($value->image) }}" data-id="{{ $value->id }}" data-main="{{ $project->id }}"><i class="fa fa-close"></i> სურათის წაშლა</div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @endforeach
