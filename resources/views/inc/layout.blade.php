<!DOCTYPE html>
<html>
    @include('vendor.admin.site-bases.inc.head')

    <body class="nav-md">
        <div class="container body">
            <div class="main_container">
                @include('vendor.admin.site-bases.inc.sidebar')
                <div class="top_nav">
                    <div class="nav_menu">
                        <nav>
                ...
                <div class="right_col" role="main">
                    @include('vendor.admin.site-bases.inc.errors')
                    @yield('content')
                </div>
            </div>
        </div>
    ...
    @include('vendor.admin.site-bases.inc.footer')
</html>
