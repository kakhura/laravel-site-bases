...
namespace Kakhura\LaravelSiteBases\Http\Controllers\Admin\Photo;

use Illuminate\Http\Request;
use Kakhura\LaravelSiteBases\Http\Controllers\Admin\Controller;
use Kakhura\LaravelSiteBases\Http\Requests\Photo\CreateRequest;
use Kakhura\LaravelSiteBases\Http\Requests\Photo\UpdateRequest;
use Kakhura\LaravelSiteBases\Models\Photo\Photo;
use Kakhura\LaravelSiteBases\Services\Photo\PhotoService;
